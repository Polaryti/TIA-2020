...
public class Data {
	...
	public static final int[][] matrizCostes = { { 11, 12, 10, 15, 19, 22, 25, 23, 21, 14, 15, 16, 19 }, // vacuna1
			{ 14, 9, 8, 12, 20, 25, 21, 18, 14, 18, 16, 15, 15 }, // vacuna2
			{ 3, 3, 1, 2, 4, 2, 4, 3, 2, 4, 1, 4, 3 } // vacuna3
	};

	public static final int[] numeroVoluntarios = { 50, 40, 30, 35, 60, 48, 56, 50, 40, 38, 20, 24, 35 };
}
